...
import { 
  ...
  Settings, ChevronLeft, ChevronRight, BookOpen, 
  Calendar, Tag
} from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="flex flex-col h-full">
        <div className={`flex items-center ${collapsed ? 'justify-center' : 'justify-between'} p-4 h-[4.5rem]`}>
          {!collapsed && <h1 className="text-xl font-semibold bg-gradient-to-r from-primary to-purple-600 bg-clip-text text-transparent animate-pulse">TechPrep</h1>}
          <button 
